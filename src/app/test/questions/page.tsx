    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-3xl pt-12 pb-16 relative z-10">
        <motion.div
          ...
          className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-indigo-50 p-8"
        >
          {/* ヘッダー部分 */}
          <div className="mb-8">
          ...
          <motion.div
            ...
            className="mt-8 bg-indigo-50 rounded-xl p-4 border border-indigo-100"
          >
